...
export default function About() {
   return (
      <div>
         ...
         <h2>ABOUT US</h2>
         <p class="about-text">We are a collaborative created to help people find sources for food by foraging! 
         ...
         <p class="about-text">We are striving to teach the community about an alternative way to source food by foraging and to educate the population on the correct ways to forage and consume plants.</p> 
      </div>
   );
}
